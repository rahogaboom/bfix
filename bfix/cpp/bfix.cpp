 ...
 *        bit_offset value as explained in note 3.  a check if both BFIX_BIG_ENDIAN and BFIX_LITTLE_ENDIAN are
 ...
 * Returns:
 *     1. void
 *     2. if defined BFIX_DEBUG, 0 on success and -1 on error
 *
 * Parameters:
 ...
 *
 * Returns:
 *     1. unsigned long - value if success and -1 on failure
 *
 * Parameters:
